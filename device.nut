...
stpmclass <- {
    ...
    "_init" : function(){
        ...
        stpmclass.stpmuart.configure(9600, 8, PARITY_NONE, 1, NO_CTSRTS, stpmclass._stpmData);
    },
    "_stpmData" : function(){
        local b = stpmuart.readblob(4);
        while (b != -1 ) {
            server.log("received: " + b);
            b = stpmuart.readblob(4);
        }
    }
    ...
    "wholepack" : function(b1,b2,b3,b4){
        pblob[0] = 0xFF & b1;
        pblob[1] = 0xFF & b2;
        pblob[2] = 0xFF & b3;
        pblob[3] = 0xFF & b4;
...
stpmclass._init();
stpmclass.readpack(0x00);
stpmclass.stpmuart.write(stpmclass.pblob);
stpmclass.readpack(0xFF);
stpmclass.stpmuart.write(stpmclass.pblob);
stpmclass.wholepack(0x04,0x03,0xCD,0xAB);
//stpmclass.stpmuart.write(stpmclass.pblob);
